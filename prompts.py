...
### 第四段：参考来源
列出本次分析中搜索和访问的所有来源，格式如下（每条来源必须包含序号、标题、URL和来源类型）：
...
**要求**：
- 必须引用实际搜索和抓取过的真实URL，不编造链接
- 每个目标市场至少列出1个来源
- 来源类型选择：政府监管机构官网 / 标准化组织 / 认证机构官网 / 行业协会 / 合规信息平台 / 其他
- 如某来源无法确认URL，写明"URL待核实"

---

## 最终输出必须完整包含以上四段，缺少任何一段均为不合格输出。
"""
